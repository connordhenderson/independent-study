...
from 
  (select 
   ...
   where 
     ...
     (date_dim.d_dom between 1 and 3 or 
      date_dim.d_dom between 25 and 28) and 
     (household_demographics.hd_buy_potential = '501-1000' or 
     ...
     date_dim.d_year in (2000, 2000+1, 2000+2) and 
     store.s_county in ('Jackson County', 'Walker County', 'Luce County', 'Franklin Parish', 'Levy County', 'Ziebach County', 'Oglethorpe County', 'Fairfield County') 
   group by 
     ss_ticket_number,
     ss_customer_sk
  ) dn,
